              ...
              <div className="rounded-xl border bg-card p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="mt-2 rounded-lg border-2 border-sky-600 bg-sky-50 p-3 shadow-sm dark:border-sky-700 dark:bg-sky-900/20">
                      <div className="flex items-start gap-2">
                        ...
                        <p className="text-xs text-sky-900 dark:text-sky-300">
                          <strong className="text-sky-950 dark:text-sky-200">Note:</strong> This is just to identify the original format. 
                          All blueprints are <strong className="text-sky-950 dark:text-sky-200">interchangeable and compatible across all AI IDEs</strong> — 
                  ...
                  <div className="rounded-lg border-2 border-amber-600 bg-amber-50 p-4 shadow-sm dark:border-amber-600 dark:bg-amber-900/20">
                    <div className="flex items-start gap-3">
                      <AlertTriangle className="h-5 w-5 flex-shrink-0 text-amber-800 dark:text-amber-400 mt-0.5" />
                      <div className="flex-1">
                        <h4 className="font-medium text-amber-950 dark:text-amber-200">
                        ...
                        <div className="mt-3 flex items-center gap-3">
                          ...
                          />
                          <label htmlFor="isPublic" className="text-sm font-medium text-amber-950 dark:text-amber-200">
