            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="rounded-xl border bg-card p-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="mt-2 rounded-lg border-2 border-sky-700 bg-sky-200 p-3 shadow-md dark:border-sky-500/50 dark:bg-sky-900/30">
                      <div className="flex items-start gap-2">
                        ...
                        <p className="text-xs font-bold text-sky-950 dark:text-sky-200">
                          <span className="font-black text-sky-950 dark:text-sky-100">Note:</span> This is just to identify the original format.
                          All blueprints are <span className="font-black text-sky-950 dark:text-sky-100">interchangeable and compatible across all AI IDEs</span> —
                  ...
                  <div className="rounded-lg border-2 border-amber-700 bg-amber-200 p-4 shadow-md dark:border-amber-500/50 dark:bg-amber-900/30">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="mt-3 flex items-center gap-3">
                          ...
                          />
                          <label htmlFor="isPublic" className="text-sm font-black text-amber-950 dark:text-amber-100">
                  ...
                  {isPublic && (
                    <div className="rounded-lg border-2 border-blue-700 bg-blue-200 p-4 shadow-md dark:border-blue-500/50 dark:bg-blue-900/30">
                      <div className="flex items-start gap-3">
                        <Sparkles className="h-5 w-5 flex-shrink-0 text-blue-800 dark:text-blue-300 mt-0.5" />
                        <div className="flex-1">
                          <h4 className="font-black text-blue-950 dark:text-blue-100">
                            Honest Disclosure
                          </h4>
                          ...
                          <div className="mt-3 flex items-center gap-3">
                            <input
                              ...
                              className="h-4 w-4 rounded border-blue-600 dark:border-blue-400"
                            />
                            <label htmlFor="aiAssisted" className="text-sm font-black text-blue-950 dark:text-blue-100">
