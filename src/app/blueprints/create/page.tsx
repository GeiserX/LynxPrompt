              ...
              <div className="rounded-xl border bg-card p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="mt-2 rounded-lg border border-sky-300 bg-white p-3 shadow-sm dark:border-sky-700 dark:bg-sky-900/20">
                      <div className="flex items-start gap-2">
                        <Info className="h-4 w-4 flex-shrink-0 text-sky-700 dark:text-sky-400 mt-0.5" />
                        <p className="text-xs text-slate-800 dark:text-sky-300">
                          <strong className="text-slate-900 dark:text-sky-200">Note:</strong> This is just to identify the original format. 
                          All blueprints are <strong className="text-slate-900 dark:text-sky-200">interchangeable and compatible across all AI IDEs</strong> — 
                  ...
                  <div className="rounded-lg border-2 border-dashed border-amber-300 bg-white p-4 shadow-sm dark:border-amber-600 dark:bg-amber-900/20">
                    <div className="flex items-start gap-3">
